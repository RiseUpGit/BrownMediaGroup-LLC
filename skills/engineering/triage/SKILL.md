...
Every comment or issue posted during triage should note: *This was generated by AI during triage.*
...
These are canonical role names. The actual label strings used in the issue tracker may differ. The mapping should have been provided to you. If not, tell the user to run `/setup-brownmediagroup-skills`.
